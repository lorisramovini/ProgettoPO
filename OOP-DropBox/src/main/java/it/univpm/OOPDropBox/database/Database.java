...
public class Database {
	...
	/**
	 * La funzione restituisce una lista contenente tutti 
	 * i file che appartengono ad un determinato membro
	 * @param listaTotale ArrayList<File> contiene la lista di tutti i file
	 * @param membroCorrente Membri contiene il membro di cui si vogliono trovare i file condivisi
	 * @return ArrayList<File> che contiene tutti i file del membro richiesto
	 */
